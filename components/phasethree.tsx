...
const DATA = [
  ...
  
    {
      ...
      content: `Build. Iterate. Integrate. Phase 3 focuses on materializing your solution, and maintaining a tight feedback loop to make sure we're building the right thing.`,
