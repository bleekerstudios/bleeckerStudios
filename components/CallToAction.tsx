...
const CallToAction = () => {
    ...
    <p></p> */}
                ...
                <button className="bg-primary-500 flex font-medium w-full md:w-auto justify-center gap-3 items-center px-8 text-white py-2 rounded-full hover:bg-primary-300  duration-30 animate-bounce">Get In Touch</button>
                </a>
